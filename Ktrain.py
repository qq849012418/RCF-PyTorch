...
import torchvision
from dataset import BSDS_Dataset, Study_Dataset
...
if __name__ == '__main__':
    ...
    train_dataset = Study_Dataset(root=args.dataset, split='train')
    # test_dataset  = Study_Dataset(root=osp.join(args.dataset, 'HED-BSDS'), split='test')
